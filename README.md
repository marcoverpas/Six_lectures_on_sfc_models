...
In the laste three decades, macroeconomic modelling has been dominated by Dynamic Stochastic General Equilibrium (DSGE) models. However, dissatisfaction with these models has been growing since the mid-2000s. Four primary weaknesses have been identified in DSGE models: unrealistic assumptions, a limited range of considerations, poor data fit, and logical inconsistencies (in addition to empirical measurement issues) in aggregate production functions.
